...
{
    public abstract class ZenjectOverlay : UnityEditor.Overlays.Overlay
    {
        [Inject]
        [NonSerialized]
        ...
        public override VisualElement CreatePanelContent()
        {
            ...
            CreatePanelContent(Root);
            return Root;
        }

        protected abstract void CreatePanelContent(VisualElement root);
